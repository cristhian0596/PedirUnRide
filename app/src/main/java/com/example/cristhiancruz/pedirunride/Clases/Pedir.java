...
public class Pedir {
    ...
    public Pedir(String fecha, String lugar_origen, String lugar_destino,
                 String cantidad_personas, String ida_vuelta, String estado_ida_vuelta,
    ...
    public String toString() {
        return "Pedir{" +
                ...
                ", cantidad_disponibles='" + cantidad_personas + '\'' +
